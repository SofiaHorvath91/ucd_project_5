...
# => Aim of object/model :
# Capture details of a quiz which has questions with related answers and results upon completion
...
# => Aim of object/model :
# Capture details of question to be answered while completing the quiz
...
# => Aim of object/model :
# Capture details of an answer which can be chosen by the user for a given question
# => Models/objects connected to Answer model/object via OneToOne relation :
# Category to represent the book genre connected to the answer (hidden from user, for backend use for result)
...
# => Aim of object/model :
# Capture details of the result which is calculated for the user upon quiz completion, based on answers
# => Models/objects connected to Result model/object via OneToOne relation :
# Category to represent the book genre which was chosen the most often (via choosing answer)
# Book to represent the recommended book in the genre represented by Category
# User to represent the user who filled out the quiz and got the result
